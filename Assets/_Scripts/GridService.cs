...
namespace CodeBase
{
    public class GridRenderService
    {
        ...
        {
            int horizontalLines = _gridSize + 1;
            int verticalLines = _gridSize + 1;
            ...
            for (int i = 0; i < horizontalLines; i++)
            {
                ...
                vertices[vertIndex + 1] = new Vector3(_gridSize * _cellSize, y - halfWidth, 0);
                vertices[vertIndex + 2] = new Vector3(0, y + halfWidth, 0);
                vertices[vertIndex + 3] = new Vector3(_gridSize * _cellSize, y + halfWidth, 0);
            ...
            for (int i = 0; i < verticalLines; i++)
            {
                ...
                vertices[vertIndex + 2] = new Vector3(x - halfWidth, _gridSize * _cellSize, 0);
                vertices[vertIndex + 3] = new Vector3(x + halfWidth, _gridSize * _cellSize, 0);
