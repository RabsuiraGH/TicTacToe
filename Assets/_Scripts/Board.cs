...
namespace CodeBase
{
    ...
    public class Board
    {
        ...
        public Board(int width, int height)
        {
            ...
            this._board = new Marker[width, height];
            Width = width;
            Height = height;
        }
        ...
        /// </returns>
        public IReadOnlyCollection<int> GetSequencesFromPosition(int x, int y, Marker marker, int minCount,
                                                                 int maxCount)
        {
            List<int> result = new(maxCount);
